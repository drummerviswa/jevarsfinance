...
function About() {
  ...
  const owners = [
    {
      para: `Jeevars Financial Office is founded and led by Mr.Ravikumar , a dynamic entrepreneur with a diploma in mechanical engineering and a passion for finance. With his expertise and vision, Jevars is committed to providing top-notch financial services to individuals and businesses.
