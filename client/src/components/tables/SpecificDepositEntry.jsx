...
function DepositSpecificEntry({ updated, setUpdated }) {
  ...
  useEffect(() => {
    fetch(`https://jevarsfinance.onrender.com/api/deposit/entries/${customer[0]["Cus_ID"]}`, {
      method: "GET",
    })
  ...
  const handleDelete = async (item) => {
    try {
      await axios.delete(`https://jevarsfinance.onrender.com/deposit/api/entries/${item.Entry_ID}`);
...
export default DepositSpecificEntry;
