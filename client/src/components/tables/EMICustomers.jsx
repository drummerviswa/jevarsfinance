...
import EMICustomerModel from "../modals/EMICustomerModal";

function EMICustomers() {
  ...
  const handleDelete = async (item) => {
    try {
      await axios.delete(`https://app-1odw.onrender.com/api/emi/customers/${item.Cus_ID}`);
