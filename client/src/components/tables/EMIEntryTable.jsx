...
function EMIEntryTable() {
  ...
  const handleDelete = async (item) => {
    try {
      ...
      setUpdated(!updated);
      toast.error(
        `${item.Entry_ID}. ${item.FirstName} -₹${item.Pay_Amount} deleted ‼️`,
        {
          position: "top-right",
          autoClose: 5000,
